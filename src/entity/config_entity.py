...
training_pipline_config: TraningPipelineConfig = TraningPipelineConfig()
...
class ModelTraninerConfig:
    ...
    model_config_file_path: str = MODEL_TRAINER_EXPECTED_SCORE
    ...
    _max_dept = MIN_SAMPLES_SPLIT_MAX_DEPTH
